...
%% Every time a timeout is hit (in this case, after Delay milliseconds), the timeout message is sent to the process.
%% Based on this, we check how many nags were sent to know if we have to send more or just quit.

...
-include_lib("kernel/include/file.hrl"). % It contains a record (#file_info{}) with a fields explaining details about the file
...
%% Checks if the file finishes in .erl, if so, returns "continuation" ({continue, Name, fun})
%% to be able to handle file (Name) first and then continue recursion.

...
%% It should be able to hold state for the curling game: teams, score and rounds to track.
%% This can all be held in a state record, changed on each event received.
